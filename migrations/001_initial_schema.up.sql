...
VALUES ('00000000-0000-0000-0000-000000000001', 'admin@example.com', 'dummy_hash', 'admin', NOW())
ON CONFLICT (id) DO NOTHING;

INSERT INTO users (id, email, password_hash, role, created_at) 
VALUES ('00000000-0000-0000-0000-000000000002', 'user@example.com', 'dummy_hash', 'user', NOW())
ON CONFLICT (id) DO NOTHING;